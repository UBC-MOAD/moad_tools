        ...
        expected = pandas.DataFrame(
            {
                ...
                "run_days": [7],
                "spill_lon": numpy.array([-124.6175], dtype=numpy.float32),
                "spill_lat": numpy.array([50.40640], dtype=numpy.float32),
                "geotiff_x_index": [134],
                "geotiff_y_index": [393],
                "vessel_type": ["other"],
        ...
        expected = pandas.DataFrame(
            {
                ...
                "run_days": [7, 7],
                "spill_lon": numpy.array([-122.8388, -123.0017], dtype=numpy.float32),
                "spill_lat": numpy.array([48.5604, 48.7390], dtype=numpy.float32),
