    ...
    for spill in range(n_spills):
        ...
        if len(ais_tracks.index) > 0.0:
            ...
            if vessel_type in tank_vessels:
                ...
                # determined as fuel spills as well as barge-type cargo spills converted to 
                # fuel-spills         
                if fuel_flag:
...
def get_oil_type_atb(oil_attribution_file,origin, destination, random_generator):
    """*** Header information to be updated *** 
...
def get_oil_type_barge(oil_attribution_file,origin, destination, random_generator):
    """  *** Header information to be updated ****
    Set 'fuel_flag'
    ...
    # *** This print statement gave values of 0.94. Seems high.  Check. ***
...
def get_oil_type_tanker(oil_attribution_file,origin, destination, random_generator):
    """ Header information to be updated """
